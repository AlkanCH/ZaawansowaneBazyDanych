...
WITH (SYSTEM_VERSIONING = ON (HISTORY_TABLE=[227445].[CustomerHistory], DATA_CONSISTENCY_CHECK=ON));
...
CREATE NONCLUSTERED INDEX [IX_Customer_EmailAddress]
    ON [227445].[Customer]([EmailAddress] ASC);
